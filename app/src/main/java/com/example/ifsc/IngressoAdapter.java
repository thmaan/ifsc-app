...
public class IngressoAdapter extends RecyclerView.Adapter<IngressoAdapter.MyViewHolder> {
    ...
    public IngressoAdapter(List<News> myData){
        this.myData = myData;
    }
    @NonNull
    @Override
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cardview_item_ingresso, parent, false);
        return new MyViewHolder(view, mListener);
    }

    @Override
    public void onBindViewHolder(@NonNull IngressoAdapter.MyViewHolder holder, int position) {
