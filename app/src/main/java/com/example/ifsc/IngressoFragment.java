...
public class IngressoFragment extends Fragment implements View.OnClickListener {
    private Api apiConnection;
    IngressoAdapter myAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_ingresso, container, false);
        RecyclerView recyclerView = view.findViewById(R.id.ingressoList);
        ...
        getNews();
        myAdapter = new IngressoAdapter(newsList);
