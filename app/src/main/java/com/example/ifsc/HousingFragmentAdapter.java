...
public class HousingFragmentAdapter extends RecyclerView.Adapter<HousingFragmentAdapter.MyViewHolder> {
    ...
    public HousingFragmentAdapter(List<News> myData){
        this.myData = myData;
    }
    @NonNull
    @Override
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cardview_item_housing, parent, false);
        return new MyViewHolder(view, mListener);
    }

    @Override
    public void onBindViewHolder(@NonNull HousingFragmentAdapter.MyViewHolder holder, int position) {
