...
public class AuxiliosFragment extends Fragment implements View.OnClickListener {
    private Api apiConnection;
    AuxiliosFragmentAdapter myAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_auxilios, container, false);
        RecyclerView recyclerView = view.findViewById(R.id.auxilioList);
        ...
        getNews();
        myAdapter = new AuxiliosFragmentAdapter(newsList);
