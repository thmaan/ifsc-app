...
public class OportunitiesFragment extends Fragment implements View.OnClickListener {
    private Api apiConnection;
    OportunitiesFragmentAdapter myAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_oportunities, container, false);
        RecyclerView recyclerView = view.findViewById(R.id.oportunitiesList);
        ...
        getNews();
        myAdapter = new OportunitiesFragmentAdapter(newsList);
