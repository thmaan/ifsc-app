...
public class PhoneFragmentAdapter extends RecyclerView.Adapter<PhoneFragmentAdapter.MyViewHolder> {
    ...
    public PhoneFragmentAdapter(List<News> myData){
        this.myData = myData;
    }
    @NonNull
    @Override
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cardview_item_phone, parent, false);
        return new MyViewHolder(view, mListener);
    }

    @Override
    public void onBindViewHolder(@NonNull PhoneFragmentAdapter.MyViewHolder holder, int position) {
