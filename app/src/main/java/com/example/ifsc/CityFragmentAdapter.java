...
public class CityFragmentAdapter extends RecyclerView.Adapter<CityFragmentAdapter.MyViewHolder> {
    ...
    public CityFragmentAdapter(List<News> myData){
        this.myData = myData;
    }
    @NonNull
    @Override
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cardview_item_city, parent, false);
        return new MyViewHolder(view, mListener);
    }

    @Override
    public void onBindViewHolder(@NonNull CityFragmentAdapter.MyViewHolder holder, int position) {
