...
public class OportunitiesFragmentAdapter extends RecyclerView.Adapter<OportunitiesFragmentAdapter.MyViewHolder> {
    ...
    public OportunitiesFragmentAdapter(List<News> myData){
        this.myData = myData;
    }
    @NonNull
    @Override
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cardview_item_oportunities, parent, false);
        return new MyViewHolder(view, mListener);
    }

    @Override
    public void onBindViewHolder(@NonNull OportunitiesFragmentAdapter.MyViewHolder holder, int position) {
