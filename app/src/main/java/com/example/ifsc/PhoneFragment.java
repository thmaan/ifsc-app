...
public class PhoneFragment extends Fragment implements View.OnClickListener {
    ...
    PhoneFragmentAdapter myAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.phoneList);
        recyclerView.setHasFixedSize(true);

        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(this.getActivity(),1,RecyclerView.HORIZONTAL,false);
        recyclerView.setLayoutManager(layoutManager);

        newsList = new ArrayList<>();
        getNews();
        myAdapter = new PhoneFragmentAdapter(newsList);
